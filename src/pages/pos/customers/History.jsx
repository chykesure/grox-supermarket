...
function History() {
  ...
  useEffect(() => {
    ...
    const fetchLedger = async () => {
      ...
      try {
        const res = await axios.get(`http://localhost:8080/api/customers/${selectedCustomerId}/ledger`);
  ...
  const handleRecordPayment = async () => {
    ...
    try {
      ...
      const res = await axios.post(
        `http://localhost:8080/api/customers/${selectedCustomerId}/payment`,
        payload
      );
      ...
      // Refresh ledger
      const ledgerRes = await axios.get(`http://localhost:8080/api/customers/${selectedCustomerId}/ledger`);
            ...
            <div className="space-y-5">
              ...
              <div className="flex gap-3 mt-6 pt-4 border-t border-gray-700/50">
                ...
                <button
                  ...
                  className={`flex-1 py-2.5 rounded-lg font-medium transition flex items-center justify-center gap-2 text-white shadow-lg shadow-emerald-900/20 ${paymentSubmitting || !paymentAmount || Number(paymentAmount) <= 0
