...
function Sidebar({ sidebarOpen, setSidebarOpen, variant = "default" }) {
  ...
  // ✅ Define flows with explicit paths
  const modules = [
    {
    ...
    <div className="min-w-fit">
      ...
      >
        ...
        <div className="space-y-4">
          ...
          <ul className="mt-2">
            {modules.map((module) => {
              const isParentActive = module.flows.some(
                (flow) => pathname.startsWith(flow.path)
              );
                ...
                >
                  {(handleClick, open) => (
                    <>
                      ...
                      <a
                        href="#0"
                        className={`flex items-center justify-between px-3 py-2 rounded-md border-l-4 transition ${isParentActive
                        ...
                        onClick={(e) => {
                          ...
                          if (!open) {
                            ...
                            handleClick();
                          } else if (module.key === "products" && location.pathname === "/products") {
                            // Redirect parent click to default sub-tab
