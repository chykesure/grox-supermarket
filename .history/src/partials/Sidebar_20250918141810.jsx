                ...
                <SidebarLinkGroup key={module.key} activecondition={pathname.includes(module.key)}>
                  {(handleClick, open) => (
                    <>
                      <a
                        href="#0"
                        className={`block text-gray-800 dark:text-gray-100 truncate transition duration-150 ${pathname.includes(module.key) ? "" : "hover:text-gray-900 dark:hover:text-white"
                          }`}
                        onClick={(e) => {
                          e.preventDefault();
                          handleClick();
