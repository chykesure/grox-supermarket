...
function Sidebar({ sidebarOpen, setSidebarOpen, variant = "default" }) {
  ...
  // Sales specific tab paths for active detection
  const salesTabs = [
    "/sales/scan-items",
    "/sales/adjust-qty",
    "/sales/coupons",
  ...
  const modules = [
    ...
    },
    {
      ...
      flows: [
        ...
        { title: "Expiry Management", icon: <Percent className="w-4 h-4" />, path: "/products/discounts" },
      ],
    },
    {
      title: "Sales",
    ...
    /* {
      ...
      flows: [
        { title: "Stock In", icon: <Box className="w-4 h-4" />, path: "/inventory/stockin" },
        { title: "Stock Out", icon: <Box className="w-4 h-4" />, path: "/inventory/stockout" },
        ...
        <div className="space-y-4">
          ...
          <ul className="mt-2">
            ...
            <div className="mt-6 px-3">
              ...
              >
                <LogIn className="w-5 h-5 rotate-180" /> {/* rotated icon for logout */}
