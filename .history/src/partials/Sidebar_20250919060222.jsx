...
function Sidebar({ sidebarOpen, setSidebarOpen, variant = "default" }) {
  ...
  const modules = [
    ...
    },
    {
      ...
      defaultPath: "/sales", // points to SalesMgt.jsx
      flows: [
        ...
        <div className="space-y-4">
          ...
          <ul className="mt-2">
            {modules.map((module) => {
              ...
              // parentActive is true if current pathname matches any child flow
              const parentActive = module.flows.some((flow) =>
                pathname === flow.path || pathname.startsWith(flow.path)
              );
                    ...
                    <>
                      ...
                      <a
                        ...
                        onClick={(e) => {
                          ...
                          // Redirect to default path if parent is clicked
