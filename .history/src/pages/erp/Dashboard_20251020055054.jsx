...
function ErpDashboard() {
  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-[#0e0f11] text-gray-100">
      {/* Sidebar */}
      ...
      <div className="flex flex-col flex-1 h-full">
        ...
        {/* Content Area */}
        <div className="flex-1 overflow-y-auto px-6 py-6 bg-gradient-to-br from-gray-900 via-gray-850 to-gray-900">
          <div className="max-w-9xl mx-auto min-h-full flex flex-col">
            {/* Page Header */}
            <div className="flex justify-between items-center mb-6 flex-wrap">
              <div>
                ...
                <p className="text-gray-400">Company-wide performance overview</p>
              </div>
            ...
            {loading ? (
              ...
              <>
                ...
                {/* Recent Activities */}
                <div className="bg-gray-900 border border-gray-700 rounded-2xl p-6 mb-2">
