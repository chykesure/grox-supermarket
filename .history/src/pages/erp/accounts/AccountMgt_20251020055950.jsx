  ...
  return (
    <div className="flex h-screen overflow-hidden bg-gradient-to-br from-gray-900 via-gray-850 to-gray-900 text-gray-200">
      ...
      <div className="flex flex-col flex-1 overflow-hidden">
        ...
        {/* Main content area */}
        <main className="flex-1 flex flex-col justify-between px-6 py-4 w-full max-w-9xl mx-auto">
          {/* Page Header */}
          <div>
          ...
          {/* Tab Content */}
          <div className="flex-1 mt-6 bg-gradient-to-br from-gray-800 to-gray-700 p-6 rounded-xl shadow-lg border border-gray-700 flex items-start justify-start">
            {renderTabContent()}
          </div>
