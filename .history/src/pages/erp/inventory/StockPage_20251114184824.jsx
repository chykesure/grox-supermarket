...
const StockPage = () => {
  ...
  const handleCurrentItemChange = (field, value) => {
    ...
    // ------------------------------------------
    // AUTO-CALCULATE MARKUP based on selling price & cost
    // ------------------------------------------
    if ((field === "sellingPrice" || field === "costPrice") &&
      ...
      updatedItem.markup = Number(
        (((updatedItem.sellingPrice - updatedItem.costPrice) /
          updatedItem.costPrice) * 100).toFixed(2)
      );
    }
    ...
    // ------------------------------------------
    // PROJECTED BALANCE = currentStock + qty
    // ------------------------------------------
