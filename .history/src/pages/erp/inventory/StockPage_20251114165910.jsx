...
const StockPage = () => {
  ...
  const handleCurrentItemChange = (field, value) => {
    ...
    if (["quantity", "costPrice", "sellingPrice", "wholesalePrice", "wholesalePackSize", "markup"].includes(field)) {
      updatedItem[field] = Number(value);
    } else {
      updatedItem[field] = value;
    }

    // Update subtotal based on costPrice * quantity
    updatedItem.subtotal = updatedItem.quantity * updatedItem.costPrice;

    // Projected stock balance
    updatedItem.projectedBalance = (updatedItem.currentStock || 0) + updatedItem.quantity;
