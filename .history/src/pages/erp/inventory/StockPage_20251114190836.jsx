...
const StockPage = () => {
  ...
  const addToCart = () => {
    ...
    // Reset current item INCLUDING markup & wholesalePrice
    setCurrentItem({
      productId: "",
      name: "",
      sku: "",
      ...
      costPrice: 0,
      sellingPrice: 0,
      markup: 0,           // 👈 clears markup
      wholesalePrice: 1,   // 👈 clears wholesale price
      wholesalePack: 1,  // 👈 clear wholesale pack here
      subtotal: 0,
      currentStock: 0,
      projectedBalance: 0,
    });
