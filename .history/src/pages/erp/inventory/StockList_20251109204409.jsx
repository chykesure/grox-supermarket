...
const StockList = ({ refreshSignal }) => {
  ...
  const totalSummaryPages = Math.ceil(filteredSummary.length / rowsPerPage);
  const totalLedgerPages = Math.ceil(filteredRecords.length / rowsPerPage);
  ...
  const renderPagination = (currentPage, totalPages, setPage) => (
    <div className="flex justify-center items-center gap-3 mt-4 text-gray-300">
      <button
      ...
      <div>
        ...
        {loadingSummary ? (
          ...
          <>
                  ...
                  {paginatedSummary.map((supplier, index) => (
                    ...
                    >
                      <td className="px-4 py-2 text-center">
                        {(summaryPage - 1) * rowsPerPage + index + 1}
                      </td>
            ...
            {renderPagination(summaryPage, totalSummaryPages, setSummaryPage)}
          </>
        )}
      </div>
              ...
              <table className="min-w-full border border-gray-700 rounded-lg text-gray-300">
                ...
                <tbody>
                  {paginatedLedger.map((s, index) => (
                    ...
                    >
                      <td className="px-4 py-2 text-center">
                        {(ledgerPage - 1) * rowsPerPage + index + 1}
                      </td>
