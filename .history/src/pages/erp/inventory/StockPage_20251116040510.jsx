    ...
    >
      ...
      <td className="px-4 py-3 text-right">
        <input
          ...
          onChange={(e) => handleEditCartItem(index, "costPrice", e.target.value)}
        />
      </td>
      ...
      <td className="px-4 py-3 text-right">
        <input
          ...
          onChange={(e) =>
            handleEditCartItem(index, "sellingPrice", e.target.value)
          }
        />
      </td>
      ...
      <td className="px-4 py-3 text-right">
        <input
          ...
          onChange={(e) =>
            handleEditCartItem(index, "wholesalePrice", e.target.value)
          }
        />
      </td>
      ...
      <td className="px-4 py-3 text-center">
        <input
          ...
          onChange={(e) =>
            handleEditCartItem(index, "wholesalePackSize", e.target.value)
          }
        />
      </td>
      ...
      <td className="px-4 py-3 text-center">
        <input
          ...
          className="w-16 bg-gray-900 border border-gray-600 text-center rounded-md px-2 py-1"
          value={item.markup}
          onChange={(e) => handleEditCartItem(index, "markup", e.target.value)}
        />
        %
      </td>
            ...
            <div className="flex justify-between items-center pt-4 border-t border-gray-700">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  disabled={isSaving}
                  className={`px-5 py-2 ${
                    isSaving ? "opacity-60 cursor-not-allowed" : "bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500"
