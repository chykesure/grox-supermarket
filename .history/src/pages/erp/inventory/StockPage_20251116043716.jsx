              ...
              onChange={(e) => {
                ...
                if (val > editForm.sellingPrice) {
                  Swal.fire({
                    icon: "error",
                    title: "Oops!",
                    text: "Cost price cannot exceed Selling Price!",
                    background: "#111827",
                    color: "#f87171",
                    confirmButtonColor: "#f87171",
                  });
              ...
              onChange={(e) => {
                ...
                if (val < editForm.costPrice) {
                  Swal.fire({
                    icon: "error",
                    title: "Oops!",
                    text: "Selling Price cannot be lower than Cost Price!",
                    background: "#111827",
                    color: "#f87171",
                    confirmButtonColor: "#f87171",
                  });
        ...
        <td className="px-4 py-3 text-center">
          {isEditing ? (
            <input
              ...
              onChange={(e) => setEditForm({ ...editForm, markup: Number(e.target.value) })}
              className="bg-gray-900 border border-gray-600 rounded px-2 py-1 text-center w-20"
            />
          ) : (
            `${item.markup}%`
