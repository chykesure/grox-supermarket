...
function AddProduct() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Use FormData to send image if needed
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              disabled={!hasExpiry}
              className={`w-full px-3 py-2 rounded-md border border-gray-700 ${
                hasExpiry
        ...
        <div className="pt-4">
          <button
            ...
            className={`w-full md:w-auto px-6 py-2 rounded-md text-white transition ${
              isSubmitting
