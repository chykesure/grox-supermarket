...
function EditProduct() {
  ...
  const handleChange = (e) => {
    ...
    setProductData((prev) => {
      ...
      // Auto-calculate sellingPrice when costPrice or markup changes
      ...
      // Generate SKU if name changes and SKU is empty
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!selectedProduct) return toast.warn("⚠️ Select a product to update", { position: "top-right" });
  ...
  return (
    <div className="max-w-3xl mx-auto bg-gray-900 p-6 rounded-lg shadow-md relative">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            ...
            <input
              ...
              readOnly
              placeholder="Auto-calculated from Cost + Markup"
              className="w-full px-3 py-2 rounded-md bg-gray-800 border border-gray-700 text-gray-200 cursor-not-allowed"
            />
          </div>
        </div>

        {/* Min & Max Qty + Category */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            <label className="block text-sm font-medium mb-1 text-gray-300">
              Min Quantity
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium mb-1 text-gray-300">Expiry Date</label>
            <input
              type="date"
              name="expiryDate"
