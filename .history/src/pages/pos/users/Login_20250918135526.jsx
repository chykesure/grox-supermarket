      ...
      <div className="w-full bg-white shadow-md rounded-xl overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center px-6 py-4 bg-gray-50 border-b gap-3">
          ...
          <div className="flex flex-wrap gap-2 w-full md:w-auto">
            ...
            <select className="border rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none w-full md:w-auto">
            ...
            <button className="bg-gray-200 hover:bg-gray-300 text-gray-700 font-medium px-4 py-2 rounded-lg inline-flex items-center gap-2 w-full md:w-auto">
