...
function Password() {
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      const res = await fetch(`/api/users/${selectedUser}/reset-password`, {
        method: "PUT",
          ...
          <form className="grid gap-6" onSubmit={handleResetPassword}>
            ...
            <div>
              ...
              <select
                ...
                className="w-full bg-gray-900 border border-gray-600 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none text-gray-200"
              >
