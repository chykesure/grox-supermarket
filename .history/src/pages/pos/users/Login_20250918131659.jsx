...
import { cilUser, cilSave, cilPencil, cilTrash, cilCheckCircle, cilBan } from "@coreui/icons";
              ...
              <CTableBody>
                <CTableRow>
                  ...
                  <CTableDataCell className="text-center">
                    <CButton size="sm" color="info" className="me-2" title="Edit">
                      <CIcon icon={cilPencil} />
                    </CButton>
                    <CButton size="sm" color="danger" className="me-2" title="Deactivate">
                      <CIcon icon={cilBan} />
                    </CButton>
                ...
                <CTableRow>
                  ...
                  <CTableDataCell className="text-center">
                    ...
                    <CButton size="sm" color="danger" className="me-2" title="Delete">
                      <CIcon icon={cilTrash} />
                    </CButton>
                    <CButton size="sm" color="success" title="Activate">
                      <CIcon icon={cilCheckCircle} />
