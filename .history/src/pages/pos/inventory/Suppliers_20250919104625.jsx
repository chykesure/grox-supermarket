            ...
            {suppliers.map(s => (
              <tr key={s.id} className="hover:bg-gray-700">
                ...
                <td className="px-4 py-2 flex justify-center gap-2">
                  ...
                  <button className="p-1 rounded hover:bg-gray-700" onClick={() => removeSupplier(s.id)}>
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
          <div className="bg-gray-900 p-6 rounded-xl w-96 shadow-lg">
            ...
            <div className="flex flex-col gap-3">
              <input className="px-3 py-2 rounded bg-gray-800 border border-gray-700 text-white" placeholder="Supplier Name" value={modalSupplier.name} onChange={e => setModalSupplier({ ...modalSupplier, name: e.target.value })} />
              <input className="px-3 py-2 rounded bg-gray-800 border border-gray-700 text-white" placeholder="Contact Person" value={modalSupplier.contact} onChange={e => setModalSupplier({ ...modalSupplier, contact: e.target.value })} />
              <input className="px-3 py-2 rounded bg-gray-800 border border-gray-700 text-white" placeholder="Email" value={modalSupplier.email} onChange={e => setModalSupplier({ ...modalSupplier, email: e.target.value })} />
              <input className="px-3 py-2 rounded bg-gray-800 border border-gray-700 text-white" placeholder="Phone" value={modalSupplier.phone} onChange={e => setModalSupplier({ ...modalSupplier, phone: e.target.value })} />
              <input className="px-3 py-2 rounded bg-gray-800 border border-gray-700 text-white" placeholder="Address" value={modalSupplier.address} onChange={e => setModalSupplier({ ...modalSupplier, address: e.target.value })} />
            </div>
