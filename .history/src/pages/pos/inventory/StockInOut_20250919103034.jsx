      ...
      <div className="overflow-auto flex-1 rounded-xl bg-gray-800 p-4 border border-gray-700 shadow-lg">
        ...
        <table className="w-full table-fixed border-collapse">
          <thead className="bg-gray-900">
            <tr>
              <th className="px-4 py-2 border-b border-gray-700 text-left w-2/6">Product</th>
              <th className="px-4 py-2 border-b border-gray-700 text-left w-2/6">Category</th>
              <th className="px-4 py-2 border-b border-gray-700 text-center w-1/12">Stock</th>
              <th className="px-4 py-2 border-b border-gray-700 text-center w-1/12">Price</th>
              <th className="px-4 py-2 border-b border-gray-700 text-center w-2/6">Actions</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-gray-700">
            {products.map(p => (
              <tr key={p.id} className="hover:bg-gray-700">
                ...
                <td className={`px-4 py-2 font-bold text-center ${p.stock <= 5 ? 'text-red-400' : 'text-green-400'}`}>{p.stock}</td>
