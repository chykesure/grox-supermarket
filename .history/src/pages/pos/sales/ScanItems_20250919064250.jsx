...
import { ShoppingCartIcon, TrashIcon, PlusIcon, MinusIcon, CashIcon, XCircleIcon } from "@heroicons/react/outline";
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="w-1/4 p-4 border-r border-gray-700 overflow-y-auto bg-gray-800">
          <h2 className="text-xl font-bold mb-4 text-blue-400 flex items-center gap-2">
            <ShoppingCartIcon className="w-6 h-6" /> Scan / Search Product
          </h2>
              ...
              .map((product) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <PlusIcon className="w-5 h-5 text-green-400 hover:text-green-300" />
                  </div>
                </li>
              ))}
          </ul>
                ...
                <div key={item.id} className="flex justify-between items-center border-b border-gray-700 p-2 hover:bg-gray-700 rounded transition">
                  ...
                  <div className="flex items-center gap-1">
                    <button onClick={() => updateQuantity(item.id, item.quantity - 1)}>
                      <MinusIcon className="w-5 h-5 text-yellow-400 hover:text-yellow-300" />
                    </button>
                    <input
                      type="number"
                      value={item.quantity}
        ...
        <div className="w-1/4 p-4 border-l border-gray-700 flex flex-col justify-between bg-gray-800">
          <div>
            <h2 className="text-xl font-bold mb-4 text-blue-400 flex items-center gap-2">
              <CashIcon className="w-6 h-6" /> Payment
            </h2>
