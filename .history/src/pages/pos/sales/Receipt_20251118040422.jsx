...
function Receipt() {
  ...
  // ✅ Automatically populate invoice number from navigation state
  useEffect(() => {
          ...
          >
            <div className="text-center mb-4">
              <div className="flex justify-center items-center mb-2 space-x-2">
                ...
                <h2 className="text-2xl font-bold text-white">Grox Shopping Store</h2>
              </div>

              <p className="text-gray-400">B338 Imo-Akure Road, Ilesha, Osun State</p>
              <p className="text-gray-400">{currentDate}</p>

              <div className="mt-3 inline-block bg-yellow-400 text-gray-900 px-3 py-1 rounded-md font-bold shadow">
                🧾 Invoice #: {sale.invoiceNumber}
              </div>
              {/* Cashier name */}
  <div className="mt-1 inline-block bg-gray-700 text-gray-200 px-3 py-1 rounded-md font-medium shadow">
