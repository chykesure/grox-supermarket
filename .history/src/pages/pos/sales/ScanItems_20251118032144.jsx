...
function ScanItems() {
  ...
  // Default to "Walk-in" but try to get username reliably
  ...
  useEffect(() => {
    ...
    // Listen for storage changes in case username is set later
  ...
  const handleCheckout = async () => {
    ...
    // ✅ Get cashier from state or fallback to localStorage or "Walk-in"
    const cashier = cashierName || localStorage.getItem("username") || "Walk-in";
