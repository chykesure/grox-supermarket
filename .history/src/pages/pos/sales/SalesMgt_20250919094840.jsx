...
function SalesMgt() {
  ...
  <div className="px-4 sm:px-6 lg:px-8 py-4 w-full max-w-7xl mx-auto flex-1 flex flex-col">
    {/* Page Header */}
    <div className="mb-4">
    ...
    {/* Tab Content */}
    <div className="bg-gradient-to-br from-gray-800 to-gray-700 p-4 rounded-xl shadow-lg border border-gray-700 flex-1 overflow-hidden">
      {renderTabContent()}
    </div>
  </div>
</main>
