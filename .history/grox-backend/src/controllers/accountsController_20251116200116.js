...
export const createUser = async (req, res) => {
    try {
        ...
        const userEmail = email || `${username.replace(/\s+/g, "_")}@example.com`;

        // Use provided password or default one
        ...
        const user = await User.create({
            ...
            forcePasswordChange: true, // Force user to change default password on first login
        });
