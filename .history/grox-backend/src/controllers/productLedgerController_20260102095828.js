...
export const getProductLedger = async (req, res) => {
  try {
    ...
    // Only apply supplier filter if valid
    ...
    // --- 3. Fetch sales for this product from Sale model ---
    ...
    for (const sale of sales) {
      ...
      for (const item of relevantItems) {
        ledgerEntries.push({
          ...
          costPrice: 0, // Optional: implement FIFO if you want real cost
